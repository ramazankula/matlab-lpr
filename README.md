...
## First Step: Preparing image for finding plate location.
...
```
## Second Step: Plate localization and cropping the plate
  - Using regionprops function find the center of plate and get coordinates of license plate location.
...
```
## Third Step: Character segmentation and extraction
  - Using  bwlabel function label each character on the license plate.
...
```
## Final Step: Optical Character Recognition (OCR)
  - OCR part uses correlation algorithm to identify chacters and numbers.
...
%-----------------end of script--------------------------------------------
```
This project was developed for the digital image processing course at the university.
